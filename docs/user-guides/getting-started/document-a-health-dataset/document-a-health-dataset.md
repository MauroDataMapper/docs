...
To select a Data Type, click the **'Search'** box and a dropdown list of Data Types will appear. Select the relevant Data Type and this will automatically populate this field. To change the Data Type once one has been selected, click the red cross to the right of the box which will erase the previously selected Data Type, allowing you to choose another. 

You can then assign several relevant **'Classifications'** by selecting them from the dropdown menu. Once all fields are complete, click **'Submit Data Element'** to add the **Data Element** to the **[Data Class](../../../glossary/data-class/data-class.md)**. Repeat this process to add other **Data Elements**.   
